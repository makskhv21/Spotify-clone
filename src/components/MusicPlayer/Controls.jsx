...
const Controls = ({ isPlaying, repeat, setRepeat, shuffle, setRandomize, currentSongs, handlePlayPause, handlePrevSong, handleNextSong }) => (
  <div className="flex items-center justify-around md:w-36 lg:w-52 2xl:w-80">
    ...
    <BsShuffle size={20} color={shuffle ? 'red' : 'white'} onClick={() => setRandomize((prev) => !prev)} className="hidden sm:block cursor-pointer" />
  </div>
);
